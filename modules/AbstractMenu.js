...
var _initialiseProps = function _initialiseProps() {
    ...
    this.checkActive = function (index) {
        return _this2.state.activeItem === index;
    };
    ...
    this.renderChildren = function (children) {
        return _react2.default.Children.map(children, function (child) {
            ...
            if (!child.props.divider && _this2.state.selectedItem === child) {
                ...
                props.selected = true;
                props.setActiveItem = _this2.setActiveItem;
            ...
            if (child.props.defaultSelected) {
                ...
                if (_this2.state.activeItem === null) {
                    props.isActive = true;
                } else {
                    props.isActive = _this2.checkActive(child.props.index);
                }
